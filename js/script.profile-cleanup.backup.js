document.addEventListener("DOMContentLoaded", () => {
    ...
    function createProfileUI() {
        ...
        profileButton.innerHTML = `
            ...
            <span class="profile-info"><span class="profile-info"><span class="profile-name">Profile</span><span class="profile-company">No company set</span></span><span class="profile-company">No company set</span></span>
        `;
    ...
    function updateProfileDisplay() {
        ...
        if (company) {
            company.textContent = profile.company || "No company set";
        }
